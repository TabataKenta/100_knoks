...
# p72.py の freeze=False にすることで、単語ベクトルも学習（更新）対象にしたもの
class LogisticRegressionFineTune(nn.Module):
    def __init__(self, embedding_matrix):
        super().__init__()
        # freeze=False にすることで、単語ベクトルも学習（更新）対象にする
...
if __name__ == '__main__':
    ...
    model = LogisticRegressionFineTune(embedding_matrix).to(device)
    ...
    for epoch in range(10):
        ...
        with open('p78_result.txt', 'a') as f:
            f.write(dev_msg + '\n')
